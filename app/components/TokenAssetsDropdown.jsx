...
const TokenAssetsDropdown = ({ assets, onSelect }) => {
  return (
    <div className="bg-[#0c1526] border border-white border-opacity-5 absolute right-[1px] top-[54px] md:top-[54px] p-2 rounded-lg w-[150px] animate-slideDown flex flex-col items-center z-50 max-h-[50px] overflow-y-auto scrollbar-thin">
