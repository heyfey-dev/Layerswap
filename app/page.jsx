  ...
  return (
    <main className="font-sans bg-[#0b1124] h-[100vh] w-full overflow-y-hidden">
      ...
      <div className="mt-16">
        ...
        <form className="container mx-auto bg-[#0c1526] w-[28%] p-6 rounded-xl mt-10 border border-white border-opacity-10">
          <section>
            <div className="flex flex-col space-y-7 relative">
              <div className="bg-[#111c36] rounded-md py-4 px-3 space-y-1">
                ...
                <div className="flex justify-between space-x-2 w-[100%] bg-[#14213d] border border-white border-opacity-5 cursor-pointer py-3 px-2 text-white opacity-80 outline-none rounded-md text-opacity-60">
                  <input type="text" placeholder="Loopring" disabled className="bg-transparent" />
                  <FaChevronDown />
                </div>
              </div>
